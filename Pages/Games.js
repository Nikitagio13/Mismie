  ...
  return (
    <ScrollView style={styles.scrollview}>
      <View style={styles.container}>
        <TouchableOpacity
          onPress={() => {
            pressHandlerSextynineRules();
            hapticsM();
          }}
        >
          <View style={styles.contForImg}>
            <Image
              source={require("../assets/photos/69.png")}
        ...
        <TouchableOpacity
          onPress={() => {
            pressHandlerDamisxiRules();
            hapticsM();
          }}
        >
          <View style={styles.contForImg}>
            <Image
              source={require("../assets/photos/damisxi1.jpg")}
              style={styles.gameicon}
            />
          </View>
        ...
        <TouchableOpacity
          onPress={() => {
            pressHandlerIsevDamisxiRules();
            hapticsM();
          }}
        >
          <View style={styles.contForImg}>
            <Image
              source={require("../assets/photos/isevDamisxi.png")}
              style={styles.gameicon}
            />
          </View>
        ...
        <TouchableOpacity
          onPress={() => {
            pressHandlerIgrialeRules();
            hapticsM();
          }}
        >
          <View style={styles.contForImg}>
            <Image
              source={require("../assets/photos/igriale.png")}
              style={styles.gameicon}
            />
          </View>
        ...
        <TouchableOpacity
          onPress={() => {
            pressHandlerDampluriRules();
            hapticsM();
          }}
        >
          <View style={styles.contForImg}>
            <Image
              source={require("../assets/photos/dampluri.png")}
              style={styles.gameicon}
            />
          </View>
        ...
        <TouchableOpacity
          onPress={() => {
            pressHandlerKidevDamisxiRules();
            hapticsM();
          }}
        >
          <View style={styles.contForImg}>
            <Image
              source={require("../assets/photos/mismie.jpg")}
              style={styles.gameicon}
            />
          </View>
      ...
      <View style={styles.bonusCardsWrap}>
        <TouchableOpacity
          style={styles.bonusCardsTouchable}
          onPress={() => {
        ...
        >
          <Image
            style={styles.bonusCards}
            source={require("../assets/photos/playingcards2.png")}
          />
