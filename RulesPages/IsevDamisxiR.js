    ...
    <View style={styles.gamesView}>
      <View style={styles.mainContainer}>
        <Text style={styles.gamesTextForRulesPage}>
          წესები მარტივია. ერთმანეთის მიყოლებით, საათის ისრის მიმართულებით,
          იღებთ კარტს და ასრულებთ მასზე დატანილ დავალებას. წინააღმდეგ
          შეტხვევაში, სვამთ. თუ მძიმე ალკოჰოლური სასმლის გამოყენებით თამაშობთ,
          შეგიძლიათ შეამციროთ დალევის რაოდენობა.{"\n"}
          {"\n"}
