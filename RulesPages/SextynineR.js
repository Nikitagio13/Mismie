    ...
    <View style={styles.gamesView}>
       <View style={styles.mainContainer}>
                <Text style={styles.gamesTextForRulesPage}>
                        თამაში წყვილებისთვის! გაატარე დაუვიწყარი საღამო შენს ყოფილ, ახლანდელ ან მომავალ პარტნიორთან ერთად.{'\n'}{'\n'}{'\n'}რიგრიგობით იღებთ კარტებს, კითხულობთ მათზე დატანილ დავალებებს, რომლებსაც
                        ასრულებთ, ან სვამთ. თუ მძიმე ალკოჰოლური სასმლის გამოყენებით თამაშობთ, შეგიძლიათ შეამციროთ დალევის რაოდენობა.{'\n'}{'\n'}{'\n'} ნებისმიერ მოთამაშეს შეუძლია, ნებისმიერ დროს,
                        გამოეთიშოს თამაშს.
                </Text>
