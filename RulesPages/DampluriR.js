    ...
    <View style={styles.gamesView}>
      <View style={styles.mainContainer}>
        <Text style={styles.gamesTextForRulesPage}>
          <Text style={styles.gamesTextRPDampluri}>
            ზნეობას და მორალს მოკლებული თამაში. ეცადეთ არ ინანოთ, რომ ის
            შეიძინეთ.
          </Text>
          {"\n"}
          {"\n"}
          {"\n"}
          რიგ-რიგობით იღებთ ბარეთებს, ხმამაღლა კითხულობთ ტექსტებს და იშვერთ
          თითებს სასურველი მოთამაშისკენ. ყოველ ჯერზე სვამს ის, ვისკენაც ყველაზე
          მეტ თითს გაიშვერენ და ისინიც, ვინც არავისკენ გაიშვერენ თითს.
          {"\n"}
