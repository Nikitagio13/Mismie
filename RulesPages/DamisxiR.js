...
export default function DamisxiRules({ navigation }) {

    const pressHandlerDamisxiR = () => {
  ...
  return (
    ...
    <View style={styles.gamesView}>
       <View style={styles.mainContainer}>
                ...
                <TouchableOpacity style={styles.button} onPress={() => {pressHandlerDamisxiR(); hapticForStart()}}><Text style={styles.buttonText}>თამაშის დაწყება</Text></TouchableOpacity>
         </View> 
